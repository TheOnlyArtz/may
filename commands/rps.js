...
exports.run = async (client,msg,args) => {
    if (!args[0]) return msg.channel.send("Please choose rock, paper or scissors");
    let choice = args[0].toLowerCase();
    choice = choice === "r" ? "rock" : choice;
    choice = choice === "p" ? "paper" : choice;
    choice = choice === "s" ? "scissors" : choice;
    if (!rps.includes(choice)) return msg.channel.send("Please choose rock (r), paper (p) or scissors (s)");
